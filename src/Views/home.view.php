...
<section class="popular-products section section--md">
    ...
    <?php
    $popularProducts = [
        ['id' => 1, 'name' => 'Apple', 'https://th.bing.com/th/id/OIP.H3W1jzOge8Q9gi0A60pUOQHaFJ?rs=1&pid=ImgDetMain' => 'img-02.png', 'formatted_price' => '$1.99'],
        ['id' => 2, 'name' => 'Carrot', 'image_url' => 'carrot.jpg', 'formatted_price' => '$0.99'],
        ['id' => 3, 'name' => 'Banana', 'image_url' => 'banana.jpg', 'formatted_price' => '$1.29'],
        ['id' => 4, 'name' => 'Lettuce', 'image_url' => 'lettuce.jpg', 'formatted_price' => '$2.49'],
        ['id' => 5, 'name' => 'Tomato', 'image_url' => 'tomato.jpg', 'formatted_price' => '$1.59'],
                ...
                <?php foreach ($popularProducts as $product): ?>
                    <div class="cards-md">
                        <div class="cards-md__img-wrapper">
                            ...
                            <img src="/images/products/img-01.png" alt="img-01">
                            </a>
